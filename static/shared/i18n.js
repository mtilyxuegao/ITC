...
const zh = {
  ...
  openaiRealtimeAudioTitle: 'OpenAI Realtime 语音',
  openaiRealtimeAudioDesc: '独立 OpenAI Realtime 语音页面：不连接 MiniCPM-o worker。',
  thinkerDesc: '双脑控制面：升档到异步 Thinker，打断时取消，并用 epoch 防止旧答案回填。',
  resources: '资源链接',
  modelRepo: '模型仓库',
  demoRepo: 'Demo 仓库',
  docs: '文档',
...
const en = {
  ...
  openaiRealtimeAudioTitle: 'OpenAI Realtime Audio',
  openaiRealtimeAudioDesc: 'Independent OpenAI Realtime voice page; it does not connect to the MiniCPM-o worker.',
  thinkerDesc: 'Two-brain control plane: escalate to an async Thinker, cancel on barge-in, and fence stale write-back by epoch.',
  resources: 'Resources',
  ...
  thinkerControl: 'Thinker Control',
