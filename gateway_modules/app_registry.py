...
_DEFAULT_APPS = [
    ...
    AppInfo(app_id="audio_duplex_openai", name="OpenAI Realtime Audio", route="/audio_duplex_openai", enabled=True),
    AppInfo(app_id="thinker", name="Thinker Control", route="/thinker", enabled=True),
]
